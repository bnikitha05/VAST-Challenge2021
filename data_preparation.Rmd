...
**Screen Shot od data folder is as below**
...
```{r}
employee_data=employee_data[,!(names(employee_data) %in% c("CitizenshipBasis","PassportCountry","BirthDate","CitizenshipStartDate",
"BirthCountry","PassportIssueDate","PassportExpirationDate"))]
